  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center py-10 px-4">
      <div className="w-full max-w-lg bg-white p-8 rounded-xl shadow-lg">
        <h1 className="text-3xl font-bold text-center text-[#594a47] mb-6">
          Add Product
        </h1>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          <div>
            <label className="block text-[#594a47] font-semibold mb-2">
              Product Name
            </label>
            <input
              type="text"
          ...
          <button
            type="submit"
            className={`w-full bg-[#594a47] text-white font-semibold py-3 rounded-lg hover:bg-[#463835] transition duration-300 ${
